...
const hi: Translation = {
  ...
  auth: {},
  hero: {
    title: 'मर्सी - सशक्तिकरण',
    subtitle: 'डिजिटल फाइनेंस',
    description: 'डिजिटल लेनदेन के भविष्य के लिए सुरक्षित, तेज़ और नवीन क्रिप्टोकरेंसी समाधान।',
  },
  cryptoPrices: {
    title: 'लाइव क्रिप्टोकरेंसी मूल्य',
    subtitle: 'रीयल-टाइम मार्केट डेटा',
    refreshesIn: 'रीफ्रेश होगा',
  },
  securityFeatures: {

...
const fa: Translation = {
  ...
  auth: {},
  hero: {
    title: 'مرسی - توانمندسازی',
    subtitle: 'مالی دیجیتال',
    description: 'راهکارهای امن، سریع و نوآورانه ارز دیجیتال برای آینده تراکنش‌های دیجیتال.',
  },
  cryptoPrices: {
    title: 'قیمت ارزهای دیجیتال',
    subtitle: 'اطلاعات بازار در لحظه',
    refreshesIn: 'بروزرسانی در',
  },
  securityFeatures: {

...
const ar: Translation = {
  ...
  hero: {
    title: 'ميرسي - تمكين',
    subtitle: 'التمويل الرقمي',
    description: 'حلول عملات رقمية آمنة وسريعة ومبتكرة لمستقبل المعاملات الرقمية.',
  },
  cryptoPrices: {
    title: 'أسعار العملات الرقمية المباشرة',
    subtitle: 'بيانات السوق في الوقت الحقيقي',
    refreshesIn: 'تحديث في',
  },
  securityFeatures: {

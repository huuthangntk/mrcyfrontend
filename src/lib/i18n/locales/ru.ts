...
const ru: Translation = {
  ...
  auth: {},
  hero: {
    title: 'Mercy - Расширение возможностей',
    subtitle: 'Цифровых финансов',
    description: 'Безопасные, быстрые и инновационные решения в области криптовалют для будущего цифровых транзакций.',
  },
  cryptoPrices: {
    title: 'Курсы криптовалют в реальном времени',
